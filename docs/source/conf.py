...
project = u'Ansible Role Manager'
copyright = u'Apache License v2'
...
texinfo_documents = [
  ('index', 'Ansible Role Manager', u'Ansible Role Manager Documentation',
   u'Andrew Mirsky', 'Ansible Role Manager', 'One line description of project.',
   'Miscellaneous'),
]
